...
| **CORE-7** | Session token replay | TA3, TA4 | JWT with a 15-min access expiry + 7-day refresh; refresh-token family tracking (reuse = revoke the entire family); dual JWT secret rotation | Mitigated | Low; replay window <15 min |
